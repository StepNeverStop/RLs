...
class MultiAgentOffPolicy(MultiAgentPolicy):
    ...
    def initialize_data_buffer(self) -> NoReturn:
        ...
        default_buffer_args = load_config(f'rls/configs/buffer/off_policy_buffer.yaml')['MultiAgentExperienceReplay'][_type]
    ...
    def prefill_store(self, expss: List[BatchExperiences]) -> NoReturn:
        # self._running_average()
        self.data.add(expss)
