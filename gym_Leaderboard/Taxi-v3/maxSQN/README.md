...
- Convergence episode: first 900, last ~3079 (max average reward for 100 episodes - ~8.3)
- max step per episode: 200
- algorithm: maxSQN
- step_before_train(random): 2500
- agents in parrallel: 4
...
train:
  ...
  base_dir: C:/RLData\Taxi-v3\maxsqn
  begin_episode: 0
  ...
  inference: false
  info: None
  load_model_path: C:/RLData\Taxi-v3\maxsqn\train_using_gym2-0
  max_episode: 5000
  max_eval_episode: 100
  max_step: 2000
  max_total_step: 1000000
  moving_average_episode: 100
  name: train_using_gym2-0
