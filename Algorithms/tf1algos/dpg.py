...
class DPG(Policy):
    ...
    def __init__(self,
        ...
        with self.graph.as_default():
            ...
            self.target_mu = Nn.actor_dpg('actor_net', self.pl_s_, self.pl_visual_s_, self.a_counts)
            ...
            self.q_target = Nn.critic_q_one('q_net', self.pl_s_, self.pl_visual_s_, self.action_target)
