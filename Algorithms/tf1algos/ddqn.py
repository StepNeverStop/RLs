...
class DDQN(Policy):
    ...
    def __init__(self,
        ...
        with self.graph.as_default():
            ...
            self.q_next = Nn.critic_q_all('q_net', self.pl_s_, self.pl_visual_s_, self.a_counts)
            ...
            self.q_target_next = Nn.critic_q_all('q_target_net', self.pl_s_, self.pl_visual_s_, self.a_counts)
