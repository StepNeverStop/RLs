    ...
    def __init__(self,
        ...
        with self.graph.as_default():
            ...
            if self.action_type == 'continuous':
                self.mu, self.sigma = Nn.actor_continuous('pg_net', self.pl_s, self.pl_visual_s, self.a_counts)
                ...
                self.action_probs = Nn.actor_discrete('pg_net', self.pl_s, self.pl_visual_s, self.a_counts)
            ...
            # ----------------------------------------------------------------
            self.net_vars = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope='pg_net')
            # ----------------------------------------------------------------
