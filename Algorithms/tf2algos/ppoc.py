...
　　　ｘｘｘｘｘ　　　　　　　　　　ｘｘｘｘｘ　　　　　　　　　　　　ｘｘｘｘｘ　　　　　　　　　　ｘｘｘｘｘｘ　　
    ...
    def choose_action(self, s, visual_s, evaluation=False):
        ...
        self._beta_adv = np.squeeze(beta_adv.numpy())
    ...
    def train_share(self, memories, kl_coef, crsty_loss, cell_state):
        ...
        with tf.device(self.device):
            with tf.GradientTape() as tape:
                ...
                beta_loss = tf.reduce_mean(beta_s * (beta_advantage + self.dc))
                ...
                o_loss = -tf.reduce_mean(
                    tf.minimum(
                        o_ratio * beta_advantage,
                        tf.clip_by_value(o_ratio, 1.0 - self.epsilon, 1.0 + self.epsilon) * beta_advantage
                    ))
