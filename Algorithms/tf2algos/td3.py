...
class TD3(Policy):
    def __init__(self,
        ...
        self.actor_net = Nn.actor_dpg(self.a_counts, 'actor')
        self.actor_target_net = Nn.actor_dpg(self.a_counts, 'actor_target')
        self.q1_net = Nn.critic_q_one('q1')
        self.q1_target_net = Nn.critic_q_one('q1_target')
        self.q2_net = Nn.critic_q_one('q2')
        self.q2_target_net = Nn.critic_q_one('q2_target')
