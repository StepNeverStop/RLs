...
class IQN(Off_Policy):
    ...
    def __init__(self,
        ...
        self.q_net = Nn.iqn_net(self.s_dim, self.visual_dim, self.a_counts, self.quantiles_idx, 'q_net', hidden_units)
        self.q_target_net = Nn.iqn_net(self.s_dim, self.visual_dim, self.a_counts, self.quantiles_idx, 'q_target_net', hidden_units)
